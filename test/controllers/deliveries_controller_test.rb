...
class DeliveriesControllerTest < ActionController::TestCase
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post :create, delivery: { address: @delivery.address, name: @delivery.name, phone: @delivery.phone, size: @delivery.size }
    end
  ...
  test "should update delivery" do
    patch :update, id: @delivery, delivery: { address: @delivery.address, name: @delivery.name, phone: @delivery.phone, size: @delivery.size }
    assert_redirected_to delivery_path(assigns(:delivery))
  end
